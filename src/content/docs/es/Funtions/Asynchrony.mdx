...
- <code>asyncio</code> : importas asyncio para acceder a funciones de asincronía

- <code>async</code> : para definir una función asincrónica

- <code>await</code> : para esperar el resultado de una operación asincrónica
