...
Para eliminar un elemento a una lista debes usar la funcion `.add()`
<Code 
code="
# Lista de frutas
conjunto1 = {'manzana', 'banana', 'pera'}
...
Puedes utilizar `discard()` para no generar error si no existe
...
Puedes obtener los elementos que están en un conjunto pero no en otro utilizando la función `.difference()`.
