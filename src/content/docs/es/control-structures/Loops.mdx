...
<Aside type="caution">
En bucles `while`, es crucial asegurarse de que la condición pueda volverse falsa eventualmente para evitar bucles infinitos.
</Aside>

## Diferencias clave

- `for` : Mejor para iterar sobre elementos de una secuencia cuando se conoce de antemano el número de iteraciones.
- `while` : Mejor para ejecutar un bloque de código mientras una condición sea verdadera, cuando el número de iteraciones no se conoce de antemano. 