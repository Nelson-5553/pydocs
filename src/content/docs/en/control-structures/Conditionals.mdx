...
Como vimos en la sección de [Operadores](/es/syntaxbasic/operators/) los Operadores logicos sirven para combinar múltiples condiciones y obtener un resultado booleano, Ya sea `True` o `False`.
