...
Converts an integer or a string that represents a number to a decimal number (float), useful when you need to work with fractional values.
<Code
code={`
print(float('3.14'))
print(float(10))
...
<Aside type='note'>
  Converts to dictionary requires a compatible structure, such as a list of tuples 
</Aside>
